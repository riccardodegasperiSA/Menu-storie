...
gulp.task(
    ...
    gulp.parallel(
        ...
        livereload, () => {
            ...
            gulp.watch(config.jsonWATCH, gulp.parallel('json'));
            gulp.watch(config.svgWATCH, gulp.parallel('svg'));
            gulp.watch(config.fontsWATCH, gulp.parallel('font'));
        }
    )
);